  ...
  return (
    <nav className={`fixed top-0 w-full z-50 transition-all duration-500 ${
      ...
      <div className="max-w-7xl mx-auto mobile-px flex justify-between items-center relative z-[70]">
        ...
        {/* Desktop Nav */}
        <div className="nav-desktop items-center gap-8">
          {navLinks.map((link) => (
            <NavLink
              key={link.name}
              to={link.path}
        ...
        <button
          ...
          className="nav-mobile-toggle text-white p-2 relative z-[70]"
      ...
      <AnimatePresence>
        {isMobileMenuOpen && (
          <motion.div
            ...
            className="fixed inset-0 bg-rich-black z-[60] flex flex-col items-center justify-center gap-6 lg:hidden h-[100dvh] w-screen mobile-menu-drawer"
          >
