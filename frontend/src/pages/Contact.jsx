        ...
        <div className="max-w-4xl mx-auto glass-card p-8 sm:p-10 md:p-16 rounded-[2rem] sm:rounded-[3rem]">
          <form className="space-y-6 sm:space-y-8">
            ...
            <div className="space-y-2">
              ...
              <textarea rows="6" placeholder="Your message here..." className="w-full bg-rich-black border border-white/10 rounded-xl p-5 sm:p-6 text-sm sm:text-base text-white focus:outline-none focus:border-primary transition-colors resize-none"></textarea>
            </div>
